...
<div class="container">
    <div class="py-5 text-center">
      <h2>회원가입</h2>
      <p class="lead">안녕하세요. 사이트를 이용해주셔서 감사합니다. 이용하고싶으시면 회원가입을 진행해 주세요.</p>
    </div>
  ...
  <div class="container">
    ...
    <div class="row g-3 mb-3">
        <div class="col-sm-6">
          ...
          <input type="text" class="form-control custom-width" id="firstName" placeholder="" value="" required>
        </div>
        <div class="col-sm-6">
          <label for="lastName" class="form-label">이름</label>
          <input type="text" class="form-control custom-width" id="lastName" placeholder="" value="" required>
        </div>
      </div>
