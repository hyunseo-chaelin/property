...
<body>
	...
	<%
		...
		ArrayList<Property> listOfproperty=dao.getAllproperty();
	%>
    ...
    <div class="album py-5 bg-body-tertiary">
        <div class="container">
            <div class="row">
                ...
                List<Property> filteredProperty = dao.getFilteredProperty(city, district);
                
                if (filteredProperty != null && !filteredProperty.isEmpty()) {
