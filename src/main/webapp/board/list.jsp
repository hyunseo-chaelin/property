...
<%
    ...
    int total_record = request.getAttribute("total_record") != null ? ((Integer) request.getAttribute("total_record")).intValue() : 0;
    int pageNum = request.getAttribute("pageNum") != null ? ((Integer) request.getAttribute("pageNum")).intValue() : 1;
    int total_page = request.getAttribute("total_page") != null ? ((Integer) request.getAttribute("total_page")).intValue() : 1;
%>
<html>
<head>
