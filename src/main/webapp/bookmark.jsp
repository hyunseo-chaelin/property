    ...
    <main>
        <section class="py-3 text-center container">
            ...
            <div class="row">
             <table width="100%">
             <tr>
             <td align="right"><a href="./deleteBookmark.jsp?BookmarkId=<%=BookmarkId%>" 
             class="btn btn-success">삭제하기</a></td>
             </tr>
             </table>
        </div>
  </section>
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    <%
                        ...
                        if (bookmarklist == null) {
                            bookmarklist = new ArrayList<Property>();
                            session.setAttribute("bookmarklist", bookmarklist);
                        }
                        for (int i = 0; i < bookmarklist.size(); i++) { 
                            Property property = bookmarklist.get(i);
                    %>
  <div class="col">
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="./removeBookmark.jsp?propertyId=<%= property.getPropertyID() %>" class="btn btn-sm btn-outline-danger">삭제하기</a>
