          ...
          <form name="newMember" onsubmit="return checkForm();" method="post" action="processMember.jsp">
            ...
            <div class="row g-3 mb-3">
              <div class="col-6">
                ...
                <input type="password" class="form-control custom-width" id="password_confirm" placeholder="password confirm" required>
              </div>
            </div>
            ...
            <div class="row g-3 mb-3">
              ...
              <div class="col-md-2">
                <select class="form-select" id="num1" required>
